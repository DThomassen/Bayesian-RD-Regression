...
beta.plot$Scenario <- factor(beta.plot$Scenario,
                   levels=c("2x_cont_p=0.3+0.3x+0.2x",
                            ...
                            "2x_cont_p=expit(1+x+x)"),
                   labels=c(expression(paste(x[i*1], " binary, ", x[i*2], "~U[-1,1], ", p[i],"=0.3+0.3",x[i*1],"+0.2",x[i*2],".")),
                            expression(paste(x[i*1], " binary, ", x[i*2], "~U[-1,1], ", p[i],"=0.4+0.3",x[i*1],"+0.2",x[i*2],".")),
                            expression(paste(x[i*1], " binary, ", x[i*2], "~U[-1,1], ", p[i],"=0.49+0.3",x[i*1],"+0.2",x[i*2],".")),
                            expression(paste(x[i*1], " binary, ", x[i*2], "~U[-1,1], ", p[i],"=expit(-1+",x[i*1],"+",x[i*2],")")),
                            expression(paste(x[i*1], " binary, ", x[i*2], "~U[-1,1], ", p[i],"=expit(0+",x[i*1],"+",x[i*2],")")),
                            expression(paste(x[i*1], " binary, ", x[i*2], "~U[-1,1], ", p[i],"=expit(1+",x[i*1],"+",x[i*2],")"))
                            ))
...
print(plot1)
ggsave(plot = plot1, filename="2x_cont.pdf", height=6, width = 8)
```
