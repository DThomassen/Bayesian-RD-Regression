...
beta.plot$Scenario <- factor(beta.plot$Scenario,
                   levels=c("1x_bin_p=0.5+0.3x",
                            ...
                            "1x_bin_p=0.9+0x",
                            "1x_bin_p=0.99+0x"),
                   labels=c(expression(paste(x[i*1], " binary, ", p[i],"=0.5+0.3",x[i*1],".")),
                            expression(paste(x[i*1], " binary, ", p[i],"=0.6+0.3",x[i*1],".")),
                            expression(paste(x[i*1], " binary, ", p[i],"=0.69+0.3",x[i*1],".")),
                            expression(paste(x[i*1], " binary, ", p[i],"=0.8+0",x[i*1],".")),
                            expression(paste(x[i*1], " binary, ", p[i],"=0.9+0",x[i*1],".")),
                            expression(paste(x[i*1], " binary, ", p[i],"=0.99+0",x[i*1],"."))
                            ))
