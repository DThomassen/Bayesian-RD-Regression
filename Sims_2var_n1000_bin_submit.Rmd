...
beta.plot$Scenario <- factor(beta.plot$Scenario,
                   levels=c("2x_bin_p=0.2+0.3x+0.3x",
                            ...
                            "2x_bin_p=expit(1+x+x)"),
                   labels=c(expression(paste(x[i*1], " binary, ", x[i*2], " binary, ", p[i],"=0.2+0.3",x[i*1],"+0.3",x[i*2],".")),
                            expression(paste(x[i*1], " binary, ", x[i*2], " binary, ", p[i],"=0.3+0.3",x[i*1],"+0.3",x[i*2],".")),
                            expression(paste(x[i*1], " binary, ", x[i*2], " binary, ", p[i],"=0.39+0.3",x[i*1],"+0.3",x[i*2],".")),
                            expression(paste(x[i*1], " binary, ", x[i*2], " binary, ", p[i],"=expit(-1+",x[i*1],"+",x[i*2],")")),
                            expression(paste(x[i*1], " binary, ", x[i*2], " binary, ", p[i],"=expit(0+",x[i*1],"+",x[i*2],")")),
                            expression(paste(x[i*1], " binary, ", x[i*2], " binary, ", p[i],"=expit(1+",x[i*1],"+",x[i*2],")"))
                            ))
