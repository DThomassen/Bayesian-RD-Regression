...
run.sim <- function(true.beta=NA, trial.dat, filename, title, true.p, beta_xlim, beta_ylim, plot_log = TRUE){
  ...
  ESSp0["1. Proposed model"] <- model$BUGSoutput$summary[10, "n.eff"]
  ESSp1["1. Proposed model"] <- model$BUGSoutput$summary[60, "n.eff"]
  ...
  ESSp0["3. Logistic model + transform"] <- model2$BUGSoutput$summary[10, "n.eff"]
  ESSp1["3. Logistic model + transform"] <- model2$BUGSoutput$summary[60, "n.eff"]
  ...
  ESSp0["2. Model by Warn et al."] <- model3$BUGSoutput$summary[10, "n.eff"]
  ESSp1["2. Model by Warn et al."] <- model3$BUGSoutput$summary[60, "n.eff"]
